...
const BOTTOM_ITEMS = [
  ...
  { icon: Lock, label: "chat lock", view: "chat-lock" },
    ...
    <TooltipProvider delayDuration={200}>
      <nav className="hidden md:flex flex-col items-center w-[60px] min-w-[60px] h-full py-4 gap-1 transition-colors duration-200 bg-slate-50 border-r border-slate-100 dark:bg-slate-950 dark:border-slate-800">
        ...
        <div className="flex flex-col items-center gap-1 w-full px-2">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button className="w-10 h-10 rounded-xl flex items-center justify-center transition-all duration-150 text-slate-400 hover:bg-red-50 hover:text-red-500 dark:text-slate-500 dark:hover:bg-red-500/10 dark:hover:text-red-400">
